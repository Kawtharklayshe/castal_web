...
import { Params } from "../../components/pages/Home/CategoriesSection/config";
        ...
        <Box sx={{ backgroundColor: "background.main" }}>
          <Container maxWidth="lg" sx={{ paddingBottom: "75px" }}>
            ...
            <Grid item xs={12} md={6} sm={12} lg={6}>
                ...
                >
                  {PublicationDetails?.images?.map((item, idx) => {

                    return (
                      <div className="mt-8 grid grid-cols-1 gap-1 lg:grid-cols-1">
                        <SwiperSlide
              ...
              >
                <div class="lg:col-span-7 md:col-span-6">
                  <div class="lg:ms-6">
                    ...
                    <div class="mt-2">
                      <span class="text-slate-400 font-semibold me-1">{data?.data?.item?.subTitle}</span>
    ...
    >
      {file.url.endsWith(".pdf") && (
        <div
          ...
          class="btn rounded-md bg-indigo-600/5 hover:bg-indigo-600 border-indigo-600/10 hover:border-indigo-600 text-indigo-600 hover:text-white mt-2"
        >
          <span
